/* ============================================================
   Os formulários das duas landing pages
   ------------------------------------------------------------
...
(() => {
  ...
  /* ─── UM FORMULÁRIO POR VEZ, E TODOS OS DA PÁGINA ───────────
     ...
     enviam para o mesmo lugar. Tudo o que é de um formulário
     (campos, erros, recado, botão, máscara) vive dentro de
     `ligar`, então cada um tem o próprio estado e nenhum enxerga
     o outro. Já foi `querySelector(".formulario")`, e o segundo
     formulário ficava morto sem ninguém perceber. */
  function ligar(formulario) {
  ...
  for (const formulario of document.querySelectorAll(".formulario")) {
    ligar(formulario);
  }
})();
